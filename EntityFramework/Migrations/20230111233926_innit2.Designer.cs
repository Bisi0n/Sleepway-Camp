...
namespace Sleepway.Migrations
{
    ...
    [Migration("20230111233926_innit2")]
            ...
            modelBuilder.Entity("Sleepway.Models.Camper", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CamperId = 2,
                            CabinId = 3,
                            EndDate = new DateTime(2022, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "David",
                            LastName = "Beckham",
                            StartDate = new DateTime(2022, 7, 2, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            CamperId = 3,
                        ...
                        new
                        {
                            CamperId = 8,
                            CabinId = 3,
                            EndDate = new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Martin",
                            LastName = "Dalberg",
                        ...
                        new
                        {
                            ...
                            FirstName = "Annika",
                            LastName = "Hermansson",
                            StartDate = new DateTime(2022, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            CamperId = 11,
                        ...
                        new
                        {
                            CamperId = 13,
                            CabinId = 2,
                            EndDate = new DateTime(2022, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Lionel",
                            LastName = "Messi",
                        ...
                        new
                        {
                            ...
                            FirstName = "Pele",
                            LastName = "Nasicmo",
                            StartDate = new DateTime(2022, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            CamperId = 17,
                            ...
                            FirstName = "Ronaldo",
                            LastName = "Nazario",
                            StartDate = new DateTime(2022, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            CamperId = 18,
            ...
            modelBuilder.Entity("Sleepway.Models.Counselor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CounselorId = 2,
                            CabinId = 2,
                            EndDate = new DateTime(2022, 6, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Mohammed",
                            LastName = "Jafari",
                            NickName = "Bossen",
                        ...
                        new
                        {
                            CounselorId = 3,
                            CabinId = 3,
                            EndDate = new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Peter",
                            LastName = "Nilsson",
                            NickName = "Professorn",
